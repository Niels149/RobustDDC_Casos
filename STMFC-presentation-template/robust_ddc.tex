...
\begin{frame}\frametitle{Goal of the Paper}
  Goal of the Paper:
  designing safe ``instructions'' (control laws) for complex machines or robots using only recorded experimental data
\end{frame}
...
\begin{frame}\frametitle{General Approach}
  General Approach:
  Typischerweise wird Sicherheit mit Barrierefunktionen zertifiziert.
\end{frame}

%--------------------------------------------------------

\begin{frame}\frametitle{New Approach}
  New Approach:
  \begin{itemize}
    \item Anstatt Barriere-Funktionen, werden Dichtefunktionen benutzt
    \item Führt zu einem konvexen Problem.
    \item -> SDP
  \end{itemize}
