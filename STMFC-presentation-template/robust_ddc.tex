...
\begin{frame}\frametitle{Proposed Solution}
  To overcome the non-convexity of barrier functions, the proposed framework uses \textbf{Density Functions} $\rho(\mathbf{x})$ as an alternative safety certificate, which was proposed in \cite{Rantzer2004}.
