...
\begin{frame}\frametitle{Goal of the Paper}
    Goal of the paper is to design a framework for safe control design from experimental data. \\
    The system is given as:
  \begin{equation*}
    \dot {\mathbf{x}}(t) = f(\mathbf{x}) + g(\mathbf{x}) u(t) + \mathbf{w}(t)
  \end{equation*}
\end{frame}

%---------------------------------------------------------
\begin{frame}\frametitle{Problem Statement}
  Safe control design from experimental data
\end{frame}
...
\begin{frame}\frametitle{Traditional Approach}
  Barrier functions for safety certification
\end{frame}
...
\begin{frame}\frametitle{Limitation}
  Non-convex optimization, computational challenges
\end{frame}
...
\begin{frame}\frametitle{Proposed Solution}
  Density functions for data-driven control
\end{frame}

%---------------------------------------------------------
\section{Key Advantage}
%---------------------------------------------------------
\begin{frame}\frametitle{Key Advantage}
  Convex reformulation using semidefinite programming (SDP)
\end{frame}
